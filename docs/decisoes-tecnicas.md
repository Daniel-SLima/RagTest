...
**Impacto:** a 0.5.11 permanece focada em groundedness/citações. A 0.5.12 inicia a validação controlada do mecanismo multi-query com subconsultas informadas explicitamente, antes de automatizar a decomposição. Os pesos do `dense-rerank` e o corpus permanecem inalterados.
