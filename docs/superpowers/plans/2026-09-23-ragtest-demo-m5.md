...
- [x] **Step 1: Especificar testes RED para catálogo e contagens**
...
- [x] **Step 3: Modelar dados versionados e inventário evidence-based**
...
- [x] **Step 4: Implementar agregações e filtros puros**
...
- [x] **Step 5: Executar GREEN e lint direcionado**
...
- [x] **Step 1: Especificar testes RED de interação e acessibilidade**
...
- [x] **Step 3: Implementar visão geral e snapshot**
...
- [x] **Step 4: Implementar cards e filtros calculados**
...
- [x] **Step 5: Implementar detalhes e dependências**
...
- [x] **Step 6: Executar GREEN e gates frontend**
...
- [x] **Step 1: Atualizar documentação sem claims novos**
...
- [x] **Step 2: Validar visualmente os quatro viewports**
...
- [x] **Step 3: Executar gates finais**
...
- [x] **Step 4: Commit local documental**
