...
const styles = StyleSheet.create({ card: { minHeight: 48, borderWidth: 1, borderRadius: 12, padding: 14, gap: 7, opacity: 0.7 }, title: { fontWeight: "700", fontSize: 16 }, status: { fontSize: 12, fontWeight: "700" } })
